...
<body>
	...
	<ul >
			...
			<div id="main">
				<div id="main2" ></div>
				<h2> Ashutosh Gupta</h2>
				    <!--img
						 id="image2" src="C:\xampp\htdocs\Basic-Banking-System-The-Spark-Foundation-main\img\ashu.jpg" align="left"-->

			    <p> I have done B.Tech in ECE from Birla institute of
						Technology,Mesra.I am a quick learner and highly
						passionate about pursuing a career in I.T. Industry.
